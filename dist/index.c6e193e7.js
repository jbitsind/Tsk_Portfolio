...
/*====================== Message Sending (Contact Form) =========================*/ // Ensure EmailJS is initialized and the form is present before proceeding
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    form.addEventListener("submit", async function(e) {
        ...
        try {
            ...
            await emailjs.sendForm("service_7z03nir", "template_cl4kre9", this // the form element
            );
...
/*====================== Read More Button Redirection =========================*/ // Supports two patterns:
...
(function() {
    ...
    readMoreButtons.forEach((btn)=>{
        btn.addEventListener('click', (e)=>{
            ...
            if (targetUrl) {
                e.preventDefault();
                if (targetUrl !== 'null') window.location.href = targetUrl;
    ...
    if (aside) aside.addEventListener('click', ()=>{
        modals.forEach((m)=>{
